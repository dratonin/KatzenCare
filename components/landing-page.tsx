      ...
      <main className="flex-1 w-full flex flex-col items-center">
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl/none">
                  Liebevolle Katzenbetreuung leicht gemacht
                </h1>
                <p className="mx-auto max-w-[700px] text-gray-600 md:text-xl">
                  Finden Sie den perfekten Katzensitter in Ihrer Nähe mit unserer einfach zu bedienenden App.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card>
                <CardContent className="flex flex-col items-center p-6">
                  ...
                  <h3 className="text-lg font-bold mb-2">Lokale Katzensitter</h3>
              ...
              <Card>
                <CardContent className="flex flex-col items-center p-6">
                  ...
                  <p className="text-center text-gray-600">Kommunizieren Sie einfach mit Ihrem Katzenbetreuer über die App.</p>
                </CardContent>
              </Card>
            </div>
          </div>
        ...
        <section id="testimonials" className="w-full py-12 md:py-24 lg:py-32 bg-orange-100 flex justify-center">
          <div className="container px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Card>
                <CardContent className="p-6">
                  <p className="italic mb-4">"Die App ist super einfach zu bedienen und ich habe schnell einen zuverlässigen Katzensitter gefunden."</p>
        ...
        <section id="download" className="w-full py-12 md:py-24 lg:py-32 bg-orange-500 text-white flex justify-center">
          <div className="container px-4 md:px-6 text-center">
            ...
            <p className="mb-8 text-lg">Laden Sie jetzt unsere App herunter und finden Sie den perfekten Katzenbetreuer!</p>
